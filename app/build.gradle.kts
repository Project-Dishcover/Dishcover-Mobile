...
android {
    namespace = "com.id.dishcover"
    compileSdk = 34

    defaultConfig {
        applicationId = "com.id.dishcover"
        minSdk = 24
        targetSdk = 33
        versionCode = 1
        versionName = "1.0"

        buildConfigField("String", "BASE_API_URL", "\"https://backend-dot-dishcoverapi.et.r.appspot.com/\"")
        buildConfigField("String", "BASE_PREDICTION_URL", "\"https://model-predict-api-tphpozvyha-et.a.run.app/\"")
...
dependencies {
    val viewModelComposeVer = "2.5.1"
    val retrofitVersion = "2.9.0"
    val loggingInterceptorVersion = "5.0.0-alpha.11"
    val daggerHiltVers = "2.46"
