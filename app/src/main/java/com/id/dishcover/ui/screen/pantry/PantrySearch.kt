...
fun PantrySearch(
    ...
    LazyVerticalGrid(columns = GridCells.Fixed(4),
        ...
        item(span = { GridItemSpan(4) }) {
            Column {
                Text(text = "Hasil Pencarian", style = Typography.titleMedium)
                Text(text = "Klik untuk menambahkan bahan ke Pantry", style = Typography.bodyMedium)
            }
        }
